...
const MODELS = [
  { id: 'openai/gpt-4o' as OpenRouterModel, name: 'GPT-4o' },
  { id: 'anthropic/claude-3.5-sonnet' as OpenRouterModel, name: 'Claude 3.5 Sonnet' },
  { id: 'google/gemini-1.5-pro' as OpenRouterModel, name: 'Gemini 1.5 Pro' },
] as const
